 # The client user execution script for Project Three - CNT 4714 - Fall 2024
...
#Command 4 - project3:
#   Query: Which rider won the 2024 Tour de France?
select ridername
from racewinners
where racename = "Tour de France" and raceyear = 2024;
